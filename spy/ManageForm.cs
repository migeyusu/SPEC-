...
namespace spy
{
    public partial class ManageForm : Form
    {
        ...
        DataSet ScoreCollection = new System.Data.DataSet();
        List<string> AMDCPUSeries = new List<string>(), IntelCPUSeries = new List<string>();
        ...
        void Ini()
        {
            ...
            TreeNode amd = new TreeNode("AMD",15,15);
            ...
            TreeNode phenom = new TreeNode("Phenom",13,13);
            ...
            TreeNode i3 = new TreeNode("Core i3",3,3);
            ...
            TreeNode i5 = new TreeNode("Core i5",4,4);
            ...
            TreeNode i7 = new TreeNode("Core i7",5,5);
            ...
            TreeNode pentium = new TreeNode("Pentium",6,6);
            ...
            TreeNode xeon = new TreeNode("Xeon",14,14);
